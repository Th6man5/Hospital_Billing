 ...
 <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-5 transition-transform -translate-x-full bg bg-sidenav border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
     ...
     <div class=" h-full px-3 pb-4 overflow-y-auto bg bg-sidenav dark:bg-gray-800">
        ...
        <?php echo (basename($_SERVER['PHP_SELF']) == 'main.php' ) ? 'bg-black bg-opacity-50 text-white' : 'text-gray-900'; ?>">
             ...
             <li>
                 <a href="http://localhost/hospital_billing/src/dokter/dokter.php" class="flex items-center p-2 text-gray-900 rounded-lg text-black hover:bg-black hover:text-white group    <?php echo (basename($_SERVER['PHP_SELF']) == 'dokter.php' || basename($_SERVER['PHP_SELF']) == 'dokter_create.php' || basename($_SERVER['PHP_SELF']) == 'dokter_edit.php') ? 'bg-black bg-opacity-50 text-white' : 'text-gray-900'; ?>">
                     <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
             ...
             <li>
                 <a href="http://localhost/hospital_billing/src/pasien/pasien.php" class="flex items-center p-2 text-gray-900 rounded-lg text-black hover:bg-black hover:text-white group    <?php echo (basename($_SERVER['PHP_SELF']) == 'pasien.php' || basename($_SERVER['PHP_SELF']) == 'pasien_create.php' || basename($_SERVER['PHP_SELF']) == 'pasien_edit.php') ? 'bg-black bg-opacity-50 text-white' : 'text-gray-900'; ?>">
             ...
             <li>
                 <a href="http://localhost/hospital_billing/src/insuransi/insuransi.php" class="flex items-center p-2 text-gray-900 rounded-lg text-black hover:bg-black hover:text-white group    <?php echo (basename($_SERVER['PHP_SELF']) == 'insuransi.php' || basename($_SERVER['PHP_SELF']) == 'insuransi_create.php' || basename($_SERVER['PHP_SELF']) == 'insuransi_edit.php') ? 'bg-black bg-opacity-50 text-white' : 'text-gray-900'; ?>">
