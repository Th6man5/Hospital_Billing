        ...
        <div class="p-4">
            ...
            <div class="grid grid-cols-4 gap-4 mb-4 ">
                <a href="/hospital_billing/src/pasien/pasien.php" class="col-span-2">
                    <div class="grid grid-cols-2 h-36 rounded bg-gray-50 dark:bg-gray-800 bg-blues2">
                        ...
                        <div class="flex justify-center items-center">
                            <svg class="flex-shrink-0 w-24 h-24 text-black transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-nav" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                ...
                <div class="grid grid-cols-2 h-36 rounded bg-gray-50 dark:bg-gray-800 col-span-2 bg-blues2">
                    ...
                    <div class="flex justify-center items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-shield-shaded flex-shrink-0 w-24 h-24 text-black transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-nav" viewBox="0 0 16 16">
