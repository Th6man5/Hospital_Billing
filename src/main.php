        ...
        <div class="p-4">
            ...
            <div class="grid grid-cols-5 gap-4 mb-4 ">
                <a href="pasien/pasien.php" class="col-span-1 group">
                    <div class="h-36  bg-gray-50 dark:bg-gray-800  bg-opacity-50 group-hover:bg-opacity-100 transition-all bg-blues2 rounded-3xl">
                        <div class="flex h-fit justify-center">
                            <h6 class="text-4xl text-white group-hover:text-black transition-all  dark:text-gray-500 ">
                                <?php
                        ...
                        <div class="flex justify-center items-center">
                            <svg class="flex-shrink-0 w-10 h-10 text-white group-hover:text-black transition-all dark:text-gray-400 group-hover:text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                ...
                <a href="dokter/dokter.php" class="col-span-1">
                    <div class="h-36 rounded-lg bg-gray-50 dark:bg-gray-800 col-span-1 bg-blues2">
                        ...
                        <div class="flex justify-center items-center">
                            <svg class="flex-shrink-0 w-10 h-10 text-black transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-nav" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
